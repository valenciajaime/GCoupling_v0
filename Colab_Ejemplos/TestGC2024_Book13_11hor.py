#Prueba GCoupling 2024-dic-7 sabado 20:31
...
#figra 10.11 electrodo horizontal 20 metros respuesta en tiempo
...
S1.Add_conduct([0,0,0.6, 0,20,0.6,0.01,Conductancia],ps=20) #caso VISACRO
# #S1.Add_conduct([5,0,0.5,8,0,0.5,0.007,Conductancia],ps=6) #caso VISACRO
...
MakeFBode(S_S1.HHz,S_S1.ZZ,nfile="GC_Book_13_11hor.csv")# #
